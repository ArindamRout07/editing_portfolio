...
const projects = [
  {
    ...
    description: "A high-octane hyperlapse cinematic exploration of Tokyo at night. Featuring meticulous color correction, speed ramping, and neon-drenched visual design to emphasize the cyberpunk essence.",
  ...
  },
  {
    ...
    description: "A breathtaking narrative-driven journey through the deep snow forests and monumental peaks of Alaska. Edited using natural ambient design and cinematic dynamic transitions to create a slow-paced meditative experience.",
    thumbnail: "https://images.unsplash.com/photo-1482862549707-f63cb32c5fd9?auto=format&fit=crop&w=800&q=80",
    videoUrl: "https://assets.mixkit.co/videos/preview/mixkit-aerial-view-of-thick-snow-covering-forest-trees-41551-large.mp4",
  ...
  },
  {
    ...
    description: "A fast-paced music festival recap that syncs visual rhythm precisely with electronic sound design. Utilizing custom light leaks, match cuts, and frame blending to construct a mesmerizing atmosphere.",
  ...
  },
  {
    ...
    description: "An introspective cinematic sequence depicting isolation in autumn weather. Focused heavily on high dynamic range grading, subtle foley integration, and raw visual storytelling.",
    thumbnail: "https://images.unsplash.com/photo-1475924156734-496f6cac6ec1?auto=format&fit=crop&w=800&q=80",
    videoUrl: "https://assets.mixkit.co/videos/preview/mixkit-man-walking-alone-on-a-foggy-road-in-autumn-41584-large.mp4",
  ...
  },
  {
    ...
    description: "An ultra-modern vertical format campaign edit highlighting urban streetwear. Custom animated text overlays, match cuts, and sudden momentum shifts optimized for mobile platforms.",
    thumbnail: "https://images.unsplash.com/photo-1509631179647-0177331693ae?auto=format&fit=crop&w=800&q=80",
    videoUrl: "https://assets.mixkit.co/videos/preview/mixkit-holding-a-smartphone-with-a-vertical-video-screen-41705-large.mp4",
  ...
  },
  {
    ...
    description: "A dark, atmospheric digital art visualizer playing with glowing lasers and dynamic chromatic dispersion. Designed entirely programmatically and synchronized to synthesizers.",
    thumbnail: "https://images.unsplash.com/photo-1550684848-fac1c5b4e853?auto=format&fit=crop&w=800&q=80",
    videoUrl: "https://assets.mixkit.co/videos/preview/mixkit-abstract-laser-lights-background-41743-large.mp4",
...
export default function App() {
  ...
  useEffect(() => {
    ...
    const updateInteractables = () => {
      const interactables = document.querySelectorAll('a, button, .interactive-card, [role="button"]');
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-[#fafafa] relative overflow-hidden selection:bg-[#d4af37]/20 selection:text-[#d4af37]">
      ...
      {loading && (
        <div className="fixed inset-0 bg-[#050505] z-9999 flex flex-col justify-center items-center gap-4 transition-all duration-700 ease-in-out">
          ...
          <div className="h-px w-24 bg-neutral-800 relative overflow-hidden">
            <div className="absolute h-full w-12 bg-[#d4af37] animate-[shimmer_1.5s_infinite] -left-12.5" style={{
          ...
          <p className="text-[10px] tracking-[0.4em] uppercase text-neutral-500">Video Editor & CS Student</p>
        </div>
      )}
      ...
      <header className={`fixed top-0 left-0 w-full z-40 transition-all duration-300 ${
        scrolled ? 'bg-[#050505]/70 backdrop-blur-xl border-b border-neutral-900/60 py-4' : 'bg-transparent py-6'
      }`}>
        <div className="max-w-7xl mx-auto px-6 md:px-12 flex items-center justify-between">
          <a href="#" className="font-display font-bold text-xl tracking-[0.2em] hover:text-[#d4af37] transition-colors">
            AR<span className="text-[#d4af37]">.</span>
          </a>
    ...
    {muted ? (
        ...
        <div className="relative z-20 max-w-5xl mx-auto px-6 text-center flex flex-col items-center">
          ...
          <h2 className="text-lg md:text-2xl font-light text-neutral-400 tracking-widest mb-8 uppercase font-display">
            Video Editor • Reels + Cinematic Story Cuts • CS Student
          </h2>

          <p className="max-w-xl text-neutral-300 text-sm md:text-base leading-relaxed tracking-wide mb-10 font-light">
            I build fast, clean edits with sound-led pacing—so every cut earns attention, not just “looks cool.”
          </p>
      ...
      {}
      {/* Featured Work Grid */}
      <section id="work" className="py-24 md:py-36 relative z-10 max-w-7xl mx-auto px-6 md:px-12">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-4">
          <div>
            <span className="text-[10px] tracking-[0.3em] uppercase text-[#d4af37] font-semibold block mb-2">Portfolio Showcase</span>
            <h2 className="text-3xl md:text-5xl font-bold tracking-tight text-white font-display">Featured Work</h2>
          </div>
          <p className="text-neutral-400 text-xs md:text-sm max-w-sm font-light">
            Hover previews + modal specs—so you can see the edit style, tools, and pacing choices behind each piece.
          </p>
        </div>
      ...
      {}
      {/* About Me Section */}
      <section id="about" className="py-20 md:py-32 bg-neutral-950/40 relative z-10 border-y border-neutral-900/60">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <span className="text-[10px] tracking-[0.3em] uppercase text-[#d4af37] font-semibold block mb-4">Behind The Screen</span>
          <h2 className="text-3xl md:text-5xl font-bold font-display mb-6 text-white tracking-tight">About Me</h2>
          ...
          <div className="mb-8 flex flex-col items-center">
            ...
            <p className="mt-4 text-[11px] tracking-[0.35em] uppercase text-neutral-500 font-semibold">
              Video Editor • CS Student
            </p>
          </div>

          <p className="text-neutral-300 text-base md:text-xl font-light leading-relaxed mb-8 max-w-2xl mx-auto">
            I’m a <span className="text-white font-medium">Computer Science student</span> who edits like a systems thinker: audio first, pacing second, visuals last—so the final piece feels inevitable.
          </p>
          
          <p className="text-neutral-400 text-xs md:text-sm leading-relaxed max-w-xl mx-auto font-light">
            My edits lean on match-cuts, rhythm edits, and controlled “neon/contrast” grading—then I polish the details: titles that land on beats, transitions that don’t steal focus, and exports tuned for Reels/YouTube.
          </p>
        </div>
      </section>

      {/* Services Section */}
      <section id="services" className="py-24 md:py-36 relative z-10 max-w-7xl mx-auto px-6 md:px-12">
        <div className="text-center mb-20">
          <span className="text-[10px] tracking-[0.3em] uppercase text-[#d4af37] font-semibold block mb-2">My Skillset</span>
          <h2 className="text-3xl md:text-5xl font-bold tracking-tight text-white font-display">Services</h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, idx) => (
            ...
            >
              ...
              <h3 className="text-lg font-medium text-white mb-3 font-display">{service.title}</h3>
              <p className="text-neutral-400 text-xs md:text-sm leading-relaxed font-light">{service.desc}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="py-20 relative z-10 max-w-7xl mx-auto px-6 text-center">
        <span className="text-[10px] tracking-[0.3em] uppercase text-neutral-500 font-semibold block mb-8">Software Toolkit</span>
      ...
      {}
      {/* Contact Section */}
      <footer id="contact" className="py-28 md:py-36 relative z-10 border-t border-neutral-900/60 bg-[#030303]">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <span className="text-[10px] tracking-[0.3em] uppercase text-[#d4af37] font-semibold block mb-4">Let's Connect</span>
          ...
          <p className="text-neutral-400 text-xs md:text-sm max-w-md mx-auto mb-12 font-light leading-relaxed">
            Tell me the vibe + the platform (Reels/YouTube), and I’ll propose an edit approach—hooks, pacing, and the color/sound direction.
          </p>

          <div className="flex flex-col md:flex-row items-center justify-center gap-4 mb-16">
            <a 
              href="mailto:arindamrout36@gmail.com" 
              className="w-full md:w-auto px-8 py-4 bg-neutral-950 border border-neutral-900 hover:border-[#d4af37] text-white rounded-md text-xs font-semibold tracking-wider uppercase transition-all flex items-center justify-center gap-3"
            >
...
href="https://www.linkedin.com/in/arindam-rout-7a016a353"
          ...
          <div className="mt-20 pt-8 border-t border-neutral-900/60 flex flex-col md:flex-row items-center justify-between gap-4 text-[10px] text-neutral-500 uppercase tracking-widest">
            <p>© {new Date().getFullYear()} Arindam Rout. All rights reserved.</p>
            <p>Designed with a premium cinematic vision</p>
          </div>
        </div>
      </footer>
    </div>
      ...
      {/* Video / Thumbnail Container */}
        ...
        <video 
          ...
          className={`absolute inset-0 w-full h-full object-cover transition-opacity duration-500 ${
            isHovered && isVideoReady ? 'opacity-100 scale-100' : 'opacity-0 scale-95'
          }`}
      ...
      <div className="relative w-full max-w-4xl rounded-2xl bg-[#090909] border border-neutral-800 overflow-hidden shadow-2xl shadow-black/80 flex flex-col max-h-[90vh] z-10 animate-fade-in-up">
        ...
        <div className="p-6 md:p-10 overflow-y-auto">
          ...
          <div className="flex flex-col md:flex-row gap-6 md:items-center justify-between pt-6 border-t border-neutral-900/80">
            {/* Tools list badges */}
            <div>
              <span className="text-[10px] tracking-widest text-neutral-500 uppercase font-semibold block mb-2">Tools Used</span>
